...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference("Tip.count") do
      post tips_url, params: { tip: { author: @tip.author, comment: @tip.comment, content: @tip.content } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { author: @tip.author, comment: @tip.comment, content: @tip.content } }
